...
module "velero" {
  ...
  aws_bucket_name               = "marketcircle-${local.velero_region}-${local.environment}-velero-backups"
  ...
  digitalocean_bucket_name                      = "marketcircle-${local.velero_region}-${local.environment}-velero-backups"
  ...
  digitalocean_snapshots_enabled                = true
